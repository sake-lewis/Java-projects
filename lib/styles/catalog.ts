...
export const STYLES: Record<StyleId, StyleDef> = {
  ...
  1: def(1, "nature", 1, "Terre & Racines", "Terre cuite, brun chaud, chaleur du sol natal",
    { bg: "#F4EADC", surface: "#E4CDB2", accent: "#B5683C", encre: "#4A3320" }, "clair", CORMORANT),
  2: def(2, "nature", 2, "Feuillage", "Vert profond, émeraude, fraîcheur de canopée",
    { bg: "#F2F0E6", surface: "#D8E4D6", accent: "#2F7A57", encre: "#1E3B2E" }, "clair", CORMORANT),
  3: def(3, "nature", 3, "Soleil & Sable", "Jaune doré, sable, éclat de corail",
    { bg: "#FBF3DF", surface: "#F2E0B8", accent: "#D29A3A", encre: "#6B4A23" }, "clair", PLAYFAIR),
  4: def(4, "nature", 4, "Océan Profond", "Bleu abyssal, turquoise, nacre",
    { bg: "#0F2A3D", surface: "#173A52", accent: "#3FB8AF", encre: "#F2F7F5" }, "sombre", PLAYFAIR),

  // ——— Élégance & Premium ———
  5: def(5, "elegance", 1, "Noir & Or", "Noir profond, or mat, blanc cassé",
    { bg: "#161310", surface: "#262019", accent: "#C9A35C", encre: "#F0E6D2" }, "sombre", CINZEL),
  6: def(6, "elegance", 2, "Ivoire Doux", "Blanc cassé, beige, reflets champagne",
    { bg: "#F8F2E7", surface: "#EADFC8", accent: "#BFA478", encre: "#4A3F2E" }, "clair", CORMORANT, PINYON),
  7: def(7, "elegance", 3, "Nuit Étoilée", "Bleu nuit, argent, pointe de bordeaux",
    { bg: "#14213D", surface: "#1E2E52", accent: "#B9C0CC", encre: "#F0EDE4" }, "sombre", CINZEL),
  8: def(8, "elegance", 4, "Cristal", "Blanc pur, reflets irisés, gris glacé",
    { bg: "#FBFBFA", surface: "#ECEFF1", accent: "#9FAAB2", encre: "#3A4248" }, "clair", PLAYFAIR),

  // ——— Vif & Coloré ———
  9: def(9, "vif", 1, "Éclat", "Couleurs franches, énergie maîtrisée",
    { bg: "#FDF6EC", surface: "#FAE4CB", accent: "#E2563B", encre: "#33241C" }, "clair", PLAYFAIR, CAVEAT),
  10: def(10, "vif", 2, "Fête", "Rouge, jaune, violet — la joie en grand",
    { bg: "#FFF6E8", surface: "#F8DFC0", accent: "#BE3A2B", encre: "#3A1F1B" }, "clair", PLAYFAIR),
  11: def(11, "vif", 3, "Tropical", "Turquoise, fuchsia, vert lime",
    { bg: "#F0FAF7", surface: "#C9EEDF", accent: "#0FA3A3", encre: "#14443C" }, "clair", PLAYFAIR, CAVEAT),
  12: def(12, "vif", 4, "Carnival", "Orange vif, or, rouge profond",
    { bg: "#FFF3E2", surface: "#FFDFB4", accent: "#D96C22", encre: "#5A2E10" }, "clair", CINZEL),

  // ——— Moderne & Minimaliste ———
  13: def(13, "moderne", 1, "Épuré", "Blanc, gris clair, accent noir précis",
    { bg: "#FCFCFB", surface: "#EFEFED", accent: "#1C1C1C", encre: "#2A2A2A" }, "clair", MONTSERRAT),
  14: def(14, "moderne", 2, "Urbain", "Anthracite, blanc, accent cuivré",
    { bg: "#2E3236", surface: "#3C4147", accent: "#E8734A", encre: "#F2F1EE" }, "sombre", MONTSERRAT),
  15: def(15, "moderne", 3, "Néon", "Nuit urbaine, lueur menthe électrique",
    { bg: "#101014", surface: "#1B1B22", accent: "#00E5A0", encre: "#F2F2F5" }, "sombre", MONTSERRAT),
  16: def(16, "moderne", 4, "Glace", "Blanc glacé, bleu pâle, argent",
    { bg: "#F6FAFC", surface: "#DDEAF2", accent: "#7FA8C0", encre: "#33444E" }, "clair", MONTSERRAT),
