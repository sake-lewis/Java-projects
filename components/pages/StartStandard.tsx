...
interface StartStandardProps {
  token: string;
}

export default function StartStandard({ token }: StartStandardProps) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center text-center">
      ...
      <main className="w-full max-w-2xl bg-white rounded-2xl shadow-sm border p-8 md:p-12">
        <h1 className="text-3xl font-bold mb-6 text-gray-900">Forfait Standard — 50 photos</h1>
        ...
        <Link href={`/create/standard/editor?token=${token}`}>
