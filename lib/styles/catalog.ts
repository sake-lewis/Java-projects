...
export const STYLES: Record<StyleId, StyleDef> = {
  ...
  6: def(6, "elegance", 2, "Ivoire Doux", "Blanc cassé, beige, reflets champagne",
    { bg: "#F8F2E7", surface: "#EADFC8", accent: "#BFA478", encre: "#4A3F2E" }, "clair", CORMORANT, PINYON, "roses-vintage"),
  ...
  18: def(18, "heritage", 2, "Amour & Union", "Blanc, or, rose poudré — la promesse",
    { bg: "#FDF8F2", surface: "#F4E3DA", accent: "#C26A72", encre: "#44282A" }, "clair", CORMORANT, PINYON, "roses-vintage"),
