...
interface StartPremiumProps {
  token: string;
}

export default function StartPremium({ token }: StartPremiumProps) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center text-center">
      ...
      <main className="w-full max-w-2xl bg-white rounded-2xl shadow-sm border p-8 md:p-12">
        <h1 className="text-3xl font-bold mb-6 text-gray-900">Forfait Premium — 150 photos</h1>
        ...
        <div className="text-left mb-10">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center text-gray-600">
              <span className="mr-3 text-purple-500">✓</span>
              Styles visuels luxueux
            </li>
            <li className="flex items-center text-gray-600">
              <span className="mr-3 text-purple-500">✓</span>
              PDF ultra haute qualité
            </li>
            <li className="flex items-center text-gray-600">
              <span className="mr-3 text-purple-500">✓</span>
        ...
        <Link href={`/create/premium/editor?token=${token}`}>
