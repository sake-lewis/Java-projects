    ...
    <div className="space-y-8">
      <div className="space-y-3">
        <div className="flex justify-between items-end">
          ...
          <span className="text-[12px] font-light text-[#C4956A]" style={{ fontFamily: 'var(--font-lato), sans-serif' }}>
        ...
        />
        {isNomInvalide && (
          <p className="text-[12px] font-light text-[#E53E3E]" style={{ fontFamily: 'var(--font-lato), sans-serif' }}>
